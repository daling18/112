<template>
<!-- application\index\view\dev\src\components\plan\trip\add-new-easytrip.vue -->
  <div class="wrapper">
          ...
          <el-form label-width="100px">
            ...
            <el-form-item label="行程附件" required>
              ...
              >
                ...
                <div class="el-upload__tip">支持.doc格式或.docx格式word文档、pdf文档上传，最大文件为3M</div>
              </el-upload>
            </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      doEasyStep2() {
        ...
        if (this.name === 'lineTripAddEasyTrip') {
        ...
        action({
          ...
          success: (res) => {
            if (res.data.code === 0) {
              ...
              if (this.name === 'tripAddEasyTrip') {
                this.$router.push({
                  path: '/touristroute/trip/bids',
                  query: {id: this.id}
                });
              } else if (this.name === 'lineTripAddEasyTrip') {
                this.$router.push({
      ...
      goback() {
        ...
        this.$confirm('', '操作提示', {
          ...
          } else if (this.name === 'operatingtripAddEasyTrip'){
            this.$router.push({
