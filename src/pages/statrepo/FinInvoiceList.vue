<!--D:\files\repo\bom\application\index\view\dev\src\components\finace\report\invoice.vue-->
<template>
	<div class="wrapper">
		<long-tab :id="id" :sub="3"></long-tab>
		<div class="export-box clearfix">
			<div class="fr">
				<a :href="exportFunc" class="btn" v-if="sourceFrom == 0 && $menuPermission('statrepo/finarepo/invoiceListexpo')">导出</a>
				<a :href="exportFunc" class="btn" v-else-if="sourceFrom == 1 && $menuPermission('statrepo/comprepo/invoiceListexpo')">导出</a>
			</div>
			<div class="comp"
				v-if="sourceFrom == 1">
				{{allData.org_name}}
