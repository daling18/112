<!--D:\files\repo\bom\application\index\view\dev\src\components\finace\report\month.vue-->
<template>
	<div class="wrapper">
		<long-tab :id="id" :sub="6"></long-tab>
		<!-- report-sub -->
		<div class="report-sub">
			<div class="report-sub-hd clearfix">
				<div class="fr">
					...
					<a :href="exportFunc" class="btn" v-if="sourceFrom == 0 && $menuPermission('statrepo/finarepo/monthListexpo')">导出</a>
					<a :href="exportFunc" class="btn" v-else-if="sourceFrom == 1 && $menuPermission('statrepo/comprepo/monthListexpo')">导出</a>
				</div>
				<div class="comp"
					v-if="sourceFrom == 1">
					{{allData.org_name}}
