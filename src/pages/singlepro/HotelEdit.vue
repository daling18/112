<template>
  <div class="wrapper">
    <div class="hotel-form">
      <el-form ref="hotelForm" :model="formData" :rules="rules" label-width="100px">
        ...
        <el-form-item label="酒店图片" required>
          ...
          <el-button @click="handleShowPictureDialog">本地上传</el-button>
    ...
    <!-- <upload-img-agreement :ratifyMsg=ratifyMsg :isAgreement=isAgreement :img_accord=img_accord v-on:isAgreement="handleChangeStatus()" v-on:isAgreement="handleChangeStatus()"></upload-img-agreement> -->
  </div>
</template>
          ...
          addOrEditSelfSupportHolelAsyncRequest({
            ...
            success: (params) => {
              ...
              if(code == 0){
                ...
                this.$router.replace({ name: 'SingleproHotelDetail', query: { hotelId: data.yk_hotel_id } });
              }else{
                this.$message.error(msg);
              }
            },
