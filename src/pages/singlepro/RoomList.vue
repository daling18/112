          ...
          <template slot-scope="prop">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/roomdet')">
                  <router-link :to="{ name: 'SingleproHotelRoomDetail', query: { roomId: prop.row.id } }">详情</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/aeroom') && prop.row.source != 4">
                  <router-link :to="{ name: 'SingleproHotelRoomEdit', query: { roomId: prop.row.id } }">编辑</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/roompaclist')">
                  <router-link :to="{ name: 'SingleproHotelRoomPackage', query: { hotel_id: prop.row.hotel_id, room_id: prop.row.id, source: prop.row.source } }">套餐报价</router-link>
                </el-dropdown-item>
                <template v-if="$menuPermission('singlepro/hotel/chgroomstatus')">
                  <template v-if="prop.row.status == 1">
                    <el-dropdown-item>
