  ...
  methods: {
    updateSelVal(newVal){
      ...
      if(newVal.area_0 != this.selVal.area_0.id){
        ...
        this.$set(this.selVal.area_0,'id',newVal.area_0)
        this.handleSelectArea(0,this.selVal.area_0)
      }
      if(newVal.area_1 != this.selVal.area_1.id){
        ...
        this.$set(this.selVal.area_1,'id',newVal.area_1)
        this.handleSelectArea(1,this.selVal.area_1)
      }
      if(newVal.area_2 != this.selVal.area_2.id){
        this.initialStatus ++;
        // this.selVal.area_2 = {id: newVal.area_2};
        this.$set(this.selVal.area_2,'id',newVal.area_2)
        this.handleSelectArea(2,this.selVal.area_2)
      }
      if(newVal.area_3 != this.selVal.area_3.id){
        // this.initialStatus ++;
        // this.selVal.area_3 = {id: newVal.area_3};
        this.$set(this.selVal.area_3,'id',newVal.area_3)
        this.handleSelectArea(3,this.selVal.area_3)
