// src\components\self-support\VisaList.vue
<template>
  <div class="wrapper">
    <!-- system-search -->
    ...
    <div class="system-content">
      <div class="content-list">
        <el-table :data="tableData" border style="width: 100%" tooltip-effect="light" >
          ...
          >
            <template slot-scope="scope">
              <el-dropdown v-if="isShowDropdown(scope.row.edit)" trigger="click" @command="handleOperate($event, scope.row)">
...
export default {
  ...
  methods:{
    isShowOperate(edit, data) {
      switch (edit) {
      case 1: 
        return this.$menuPermission('singlepro/visa/visadet');
      case 2:
        return this.$menuPermission('singlepro/visa/addvisa');
      case 3:
      case 4:
        return this.$menuPermission('singlepro/visa/chgvisastatus');
      case 5:
      case 6:
      case 7:
        return this.$menuPermission('singlepro/visa/putaway');
        // return this.$menuPermission('singlepro/visa/soldout');
        // return this.$menuPermission('singlepro/visa/sendback');
      default:
        return false;
      }
    },
    isShowDropdown(edits) {
      if (Array.isArray(edits) && edits.length > 0) {
        return edits.some(this.isShowOperate)
      } else {
        return false
      }
    },
