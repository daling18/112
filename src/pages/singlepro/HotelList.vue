<template>
  <div class="wrapper">
    ...
    <div v-if="$menuPermission('singlepro/hotel/eaehotel')" class="btns">
      <el-button @click="handleAddHotel">新增酒店</el-button>
    </div>
    <div class="hotel">
      <el-table
        :data="hotels"
          ...
          <template slot-scope="prop">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/hoteldet')">
                  <router-link :to="{ name: 'SingleproHotelDetail', query: { hotelId: prop.row.id } }">详情</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/eaehotel')">
                  <router-link :to="{ name: 'SingleproHotelEdit', query: { id: prop.row.id } }">编辑</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/roomlist')">
                  <router-link :to="{ name: 'SingleproHotelRoom', query: { hotel_name: prop.row.hotel_name } }">房型</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('singlepro/hotel/aeroom')">
                  <router-link :to="{ name: 'SingleproHotelRoomAdd', query: { hotelId: prop.row.id, hotelName: prop.row.hotel_name } }">添加房型</router-link>
                </el-dropdown-item>
                <template v-if="$menuPermission('singlepro/hotel/chgstatus')">
                  <template v-if="prop.row.status == 1">
                    <el-dropdown-item>
