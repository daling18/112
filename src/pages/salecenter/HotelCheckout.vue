            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="姓名" prop="contact.name">
                  <el-input v-model.trim="orderForm.contact.name" :class="'hotel-checkout-form-input'" placeholder="请输入联系人姓名"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
        ...
        <div class="hotel-checkout-panel">
          ...
          <div class="hotel-checkout-panel-bd">
            <el-form-item v-for="(tourist, key) in orderForm.tourist_list" 
               ...
               <el-input v-model.trim="tourist.name" :class="'hotel-checkout-form-input'" placeholder="主要入住人姓名"></el-input>
            </el-form-item>
          </div>
        </div>
      </el-form>
    ...
    <div class="hotel-checkout-pay">
      <div class="hotel-checkout-panel">
        ...
        <div class="hotel-checkout-panel-bd">
          ...
          <p v-if="$menuPermission('salecenter/hotel')" class="hotel-pay-type"><el-radio v-model="orderForm.pay_type" :label="2">在线支付</el-radio></p>
          <div class="hotel-price-amount">
            <p>订单金额：￥<strong>{{ totalPrice }}</strong></p>
          </div>
          <div class="hotel-order-btn">
            <el-button v-if="$menuPermission('salecenter/hotel')" type="primary" size="large" @click="createHotelRoomsOrderHandler">提交</el-button>
                  ...
                  this.$confirm('预订成功', '在线支付提示', {
                    ...
                    beforeClose: (action, instance, done) => {
                      if(action == 'confirm'){
                        ...
                        this.$router.push({ name: 'HotelSaleOrderDetail', query: { orderId: data.order_id }});
                      }
                    }
                  }).catch((e)=>{
