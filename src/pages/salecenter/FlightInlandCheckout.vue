          ...
          <div class="contact-person site-panel">
            ...
            <div class="contact-person-info">
              <el-form-item label="姓名" prop="contact.name" :rules="[
                ...
                <el-input v-model.trim="flightOrderForm.contact.name" placeholder="请输入联系人姓名"></el-input>
              </el-form-item>
        ...
        <div class="checkout-pay">
          <div class="checkout-panel">
            ...
            <div class="checkout-panel-bd">
              ...
              <p v-if="$menuPermission('salecenter/flight/inland')" class="pay-type"><el-radio v-model="flightOrderForm.pay_type" :label="2">在线支付</el-radio></p>
...
export default {
  data() {
    return {
      ...
      identityType: "",  //证件类型
      loading:false,
      // applicableTravelerCategory:[{value: 1,name: "成人(≥12周岁)"}]
    }
  },
  computed: {
    identityTypes() {
  ...
  methods: {
    ...
    addPassenger() {      
      // let  travelerArrAll = [{value: 1,name: "成人(≥12周岁)"},{value: 2,name: "儿童(2周岁≤儿童票＜12周岁)"}],
      //      travelerArrAdult = [{value: 1,name: "成人(≥12周岁)"}];
      // if (passengers.length == this.seatStatus) return;
      // let adultNum = 0,
      //     childNum = 0;
      //   passengers.forEach(item=>{       
      //     if(item.passenger_type===1){ adultNum++ } 
      //     if(item.passenger_type===2){ childNum++ }         
      //   })
      //   // console.log(adultNum,childNum,'adultNum')
      // if(childNum <adultNum*2){
      //   this.applicableTravelerCategory = travelerArrAll;
      // }else{
      //   this.applicableTravelerCategory = travelerArrAdult;
      // }
