        ...
        <div class="panel">
          ...
          <div class="panel-bd">
            <div v-for="(tourist, key) in checkoutForm.tourist_list" :key="key" class="passenger">
                ...
                <el-form-item label="乘机人姓名" required>
                  <el-col :span="11">
                    <el-form-item 
                      ...
                      :rules="[
                        { required: true, pattern: /^[a-z]+$/i, message: '请输入姓（拼音或者英文）', trigger: 'change' }
                      ]">
                      <el-input v-model.trim="tourist.last_name" placeholder="姓（拼音或者英文）"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="2">
                    &nbsp;
                  ...
                  <el-col :span="11">
                    <el-form-item 
                      ...
                      :rules="[
                        { required: true, pattern: /^[a-z]+$/i, message: '请输入名（拼音或者英文）', trigger: 'change' }
                      ]">
                      <el-input v-model.trim="tourist.first_name" placeholder="名（拼音或者英文）"></el-input>
                    </el-form-item>
                  </el-col>
                </el-form-item>
                <el-form-item 
              ...
              <div class="passenger-tool">
                <a href="javascript:;" @click="clearPassenger(key)">清空</a>
                <a href="javascript:;" @click="setContact(tourist)">设置为联系人</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="panel-bd">
            <div class="contacts">
              <el-form-item label="姓名" prop="contact.name">
                <el-input v-model.trim="checkoutForm.contact.name" placeholder="请输入联系人姓名"></el-input>
              </el-form-item>
        ...
        <div class="checkout-pay">
          <div class="checkout-panel">
            ...
            <div class="checkout-panel-bd">
              ...
              <p v-if="$menuPermission('salecenter/flight/internation')" class="pay-type"><el-radio v-model="checkoutForm.pay_type" :label="2">在线支付</el-radio></p>
...
export default {
  ...
  methods: {
                  ...
                  this.$confirm('预订成功', '在线支付提示', {
                    ...
                    beforeClose: (action, instance, done) => {
                      if(action == 'confirm'){
                        ...
                        this.$router.push({ name: 'FlightSaleOrderDetail', query: { order_id: data.order_id }});
                        done();
                      }
                    }
                  }).catch((e)=>{
    ...
    setContact(item){
      let { first_name, last_name, mobile } = item;
      if(last_name && mobile && last_name){
        this.checkoutForm.contact.name = first_name + ''+ last_name;
        this.checkoutForm.contact.mobile = mobile;
      }else{
