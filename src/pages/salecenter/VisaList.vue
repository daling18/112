// \src\components\distribution\VisaList.vue
<template>
  <div class="wrapper">
    <!-- system-search -->
    <div class="system-search">
      ...
      <div class="search-item">
        <div class="label">送签地</div>
        <el-input v-model="searchInput.send_city_name" placeholder="请输入送签地" />
      </div>
  ...
  data() {
    ...
    return {
      ...
      searchData: {
        ...
        send_city_name: query.send_city_name || '',
