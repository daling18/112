// src/components/plan/tuan-list.vue
<template>
  <div class="wrapper">
...
export default {
  ...
  computed:{
    ...
    tuituanDetailPath() {
      ...
      case 'settlement':
        return 'order-refund'; //'/fcontrol/tuituan-detail';
      }
    },
    orderDetailPerm() {
      let urlPrefix = '';
      ...
      switch(this.topMenuConst) {
      case 'operator': 
        return this.$menuPermission('api/tuan/bom_order_detail');
        break;
      case 'settlement': 
        return true; //this.$menuPermission('api/tuan/finance_bom_order_detail');
        break;
      }
      return false;
    },
    orderDetailPrefix() {
      ...
      switch(this.topMenuConst) {
      case 'operator': 
        urlPrefix = '/control/order-detail/';
        break;
      case 'settlement': 
    ...
    singleOrderDetailUrlPrefix(){
      ...
      case 1:
        v = '/plan/single-train-order/detail';
        break;
      case 2:
        v = '/plan/single-ticket-order/detail';
        break;
      case 3:
        v = '/plan/single-hotel-order/detail';
        break;
      case 4:
        v = '/plan/single-flight-order/detail';
        break;
      case 5:
        v = '/plan/single-visa-order/detail';
        break;
      case 6:
        v = '/plan/single-local-product-order/detail';
        break;
      }
      return v;
    }
