// src/components/plan/control/bill.vue
<template>
  <div class="bill-wrap">
      ...
      <div :class="applicationAccount ? 'applictionAccount-wrap' : ''">
        <div class="bill-table-wrap">
          <div class="bill-table-tit">
            收入明细
            <el-button v-if="$menuPermission('settlement/tuanac/gettuanac/expincofund')" class="right-btn" @click="uploadDoc('income')">导出收入结算表</el-button>
          </div>
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <router-link
                    ...
                    v-if="$menuPermission('settlement/tuanac/gettuanac/getincodet')">
                    查看
                  </router-link>
        ...
        <div class="bill-table-wrap">
          <div class="bill-table-tit">
            成本明细
            <el-button v-if="$menuPermission('settlement/tuanac/gettuanac/expcostfund')" class="right-btn" @click="uploadDoc('cost')">导出成本结算表</el-button>
          </div>
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  ...
                  <router-link
                    ...
                    v-if="$menuPermission('settlement/tuanac/gettuanac/getcostdet') && $route.meta.topMenuConst === 'settlement'">
                    查看
                  </router-link>
                </template>
              </el-table-column>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <router-link
                  :to="{ path: 'cost-detail', query: {aid:data.tuan_info.a_id, id:scope.row.id}}"
                  v-if="$menuPermission('settlement/tuanac/gettuanac/getcostdet') && $route.meta.topMenuConst === 'finance'">
                  查看
                </router-link>
              </template>
            </el-table-column>
      ...
      <div class="bill-table-wrap">
        ...
        <el-table
          ...
          <el-table-column
            ...
            width="150">
            <template slot-scope="scope">
              <div v-if="(scope.row.id && $menuPermission('settlement/tuanac/gettuanac/adjustmentdetail')) || (scope.row.approval_id && $menuPermission('usercenter/approval/detail'))">
                <router-link
                  v-if="scope.row.id && $menuPermission('settlement/tuanac/gettuanac/adjustmentdetail')"
                  :to="{path: 'adjustment-detail', query: {id: scope.row.id, type: 2}}"
                >查看调整</router-link>
                <router-link
                  v-if="scope.row.approval_id && $menuPermission('usercenter/approval/detail')"
                  :to="{path: '/approval/submit/detail', query: {id: scope.row.approval_id}}"
                >审批单</router-link>
              </div>
              <template v-else>--</template>
            </template>
