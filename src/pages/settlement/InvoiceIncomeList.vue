<template>
  <div class="wrapper">
    <div class="system-tab">
      <ul class="tab-box">
        <li class="on">收入发票</li>
        <router-link tag="li" v-if="$menuPermission('settlement/invoice/cost')" :to="{path:'/settlement/invoice/cost/list', query: $route.query}">
          成本回票
        </router-link>
      </ul>
      <template v-if="$menuPermission('settlement/invoice/income/edit')">
        <div class="btn">
          <router-link
    ...
    <div class="system-header">
      <el-row>
        <el-col :span="7">
          总待开金额&ensp;
          <span class="color-orange">{{ wait_invoice_amount }}</span> 元
        </el-col>
      </el-row>
    ...
    <div class="system-content">
      <div class="content-list" style="margin-top:15px;">
        <invoice-income-table prefix-url="." :table-data="tableData" @action="getTableData(true)" />
      </div>
    </div>
