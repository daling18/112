<template>
  <div class="wrapper">
    <div class="system-tab">
      ...
      <div class="btn">
        <el-button type="primary" size="long" @click="edit()" v-if="$menuPermission('settlement/conacc/peeraccount/aedpeeracc')">+ 添加同行帐户</el-button>
      </div>
    </div>
    <!-- system-search -->
    <div class="system-search">
      ...
      <div class="search-item">
        ...
        <el-input v-model="searchData.bank_number" placeholder="银行账号"/>
      </div>
      ...
      <div class="content-list">
        <div class="list">
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column min-width="160" label="银行账号" align="center" :resizable="false">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" align="center" width="80">
              <template slot-scope="scope">
                <template v-if="$menuPermission('settlement/conacc/peeraccount/aedpeeracc')"><el-button type="text" @click="edit(scope.row)">编辑</el-button></template>
                <template v-else>--</template>
              </template>
            </el-table-column>
          </el-table>
      ...
      <div class="form-content">
        <el-form :model="form">
          ...
          <el-form-item label="银行账号" :label-width="formLabelWidth" required>
            <el-input v-model="form.bank_number" placeholder="请输入银行账号" auto-complete="off"/>
          </el-form-item>
        </el-form>
      </div>
