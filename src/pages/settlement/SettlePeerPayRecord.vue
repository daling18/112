// D:\files\repo\bom\application\index\view\dev\src\components\finace\balance\pay-record.vue
<template>
  <div class="wrapper" >
      ...
      <el-row>
        <el-col :span="24">
          <router-link class="hd-btn"
            :to="{path: '/settlement/pay/pay-edit', query: {id:$route.query.id,action:1}}">
            添加付款
          </router-link>
          供应商名称：
...
export default {
  ...
  methods: {
    isShowOperate(edit, data) {
      switch (edit) {
      case 1: 
        return this.$menuPermission('settlement/pay/fukuan/getpaydet');
      case 4:
        // 作废
        return this.$menuPermission('settlement/pay/fukuan/cancelrec');
      case 5:
        // 成本结算记录列表
        return this.$menuPermission('settlement/pay/paylist/costfundreclilst');
      case 6:
    ...
    handleOperate(edit, data) {
      ...
      case 5:
        this.$router.push({
          path: '/settlement/pay/costfund-list',
