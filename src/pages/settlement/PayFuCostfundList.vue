<!--D:\files\repo\bom\application\index\view\dev\src\components\finace\balance\pay-settlment-list.vue-->
<template>
  <div class="wrapper">
    <!-- system-search -->
        ...
        <div class="list">
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column label="操作" align="center" width="120" fixed="right" >
              <template slot-scope="scope">
                <router-link v-if="$menuPermission('settlement/tuanac/gettuanac/getcostdet')" :to="{path:'/settlement/tuan-bill/cost-detail', query:{id:scope.row.bill_id}}">查看应付款</router-link>
