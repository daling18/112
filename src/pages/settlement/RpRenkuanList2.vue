<template>
  <div class="system-content">
    <div class="system-tab">
			<ul class="tab-box">
        <li v-if="$menuPermission('api/finance/all_receipt_list')" @click="goto('/settlement/recpay/receiptList',{})">收款记录</li>
				<li class="on">认款记录</li>
			</ul>
		</div>
    <!-- system-search -->
            ...
            <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-for="(o,i) in scope.row.edit"
                  :key="i">
                  <!-- 1 查看认款 -->
                  <router-link :to="{path:'renkuan-detail',query:{id:scope.row.id}}"
                    v-if="o == 1">
                    {{allData.edit_arr[o]}}
                  </router-link>
                  <!-- 2 撤销认款 -->
      ...
      if(status == 1){
        ...
        switch(sequence){
          case 2:
            ...
            this.cancelForm.data.id = row.id;
            break;
          case 3:
