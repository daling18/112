<template>
<!-- application\index\view\dev\src\components\system\PictureManagementList.vue -->
  <div class="wrapper">
    ...
    <div class="system-content">
      <div class="content-list">
        <div class="top-btn-wrap">
          <el-button v-if="$menuPermission('traveldata/photoalbum/addphotoalbumsub')" @click="openDialog()" type='default'>创建相册</el-button>
          <router-link 
            v-if="$menuPermission('traveldata/photoalbum/vcgimages')"
            :to="{
              path: '/traveldata/visionChina'
            }"
          >
        ...
        <div class="album-wrap clearfix">
          <router-link :to="{path: '/traveldata/picture-detail', query: {id: item.id}}" v-for="(item, index) in albumList" class="album-item" :key="index">
            <span v-if="$menuPermission('traveldata/photoalbum/delphotoalbumsub')" @click.prevent="delPhotoalbum(item.id)" class="album-close">X</span>
            <span v-if="$menuPermission('traveldata/photoalbum/editphotoalbumsub')" @click.prevent="openDialog(item)" class="album-edit">编辑</span>
