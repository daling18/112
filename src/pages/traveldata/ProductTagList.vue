<template>
<!-- application\index\view\dev\src\components\self-support\ProductTagList.vue -->
  <div class="wrapper">
    <div class="system-tab">
      ...
      <div class="btn">
        <el-button
          v-if="$menuPermission('traveldata/tag/addtag')"
          type="primary" 
          @click="initTagForm">+ 新增标签</el-button>
      </div>
    </div>
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-button type="text"
               v-if="$menuPermission('traveldata/tag/deletetag')" 
               @click="tagDeleteHandler(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
