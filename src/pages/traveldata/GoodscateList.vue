<template>
<!-- application\index\view\dev\src\components\self-support\GoodscateList.vue -->
  <div class="wrapper">
    <div class="system-tab">
      ...
      <el-button
        v-if="$menuPermission('traveldata/goodscate/addgoodscate')"
            ...
            <template slot-scope="scope">
              <el-dropdown trigger="click">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item
                    v-if="$menuPermission('traveldata/goodscate/delgoodscate')">
                    <div @click="del(scope)">删除</div>
                  </el-dropdown-item>
                  <el-dropdown-item
                    v-if="scope.row.flag === 2 && $menuPermission('traveldata/goodscate/changestatus')">
                    <div @click="changeStatus(scope.row)">启用</div>
                  </el-dropdown-item>
                  <el-dropdown-item
                    v-if="scope.row.flag === 1 && $menuPermission('traveldata/goodscate/changestatus')">
    ...
    <el-dialog
      ...
      <el-form
        ...
        <el-form-item
          ...
          <div>图标尺寸为宽106px * 高100px，大小不能超过200KB，图片只能为jpg、png、gif格式</div>
        </el-form-item>
        <el-form-item
          label='分类描述'>
