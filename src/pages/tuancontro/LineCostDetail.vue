<template>
<!-- application\index\view\dev\src\components\plan\cost\detail.vue -->
      ...
      <div class="receive-content">
        ...
        <div class="content-box" v-if="adjustment_detail && adjustment_detail.length > 0">
          ...
          <div v-if="adjustment_detail && adjustment_detail.length > 0">
            <div class="content-right" v-if="$route.meta.topMenuConst === 'tuancontro' && $menuPermission('api/tuan/adjustment_detail')">
