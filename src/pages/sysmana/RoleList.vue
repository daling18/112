// src\components\system\role\list.vue
<template>
  <div class="wrapper" >
            ...
            <template slot-scope="scope">
              ...
              <el-dropdown v-else trigger="click">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item v-if="isShowOperate(2, scope.row)">
                    <router-link :to="{path: 'power', query: {id:scope.row.id}}">分配权限</router-link>
                  </el-dropdown-item>
                  <el-dropdown-item v-if="isShowOperate(3, scope.row)">
                    <router-link :to="{path: 'view-power', query: {id:scope.row.id}}">查看权限</router-link>
                  </el-dropdown-item>
...
export default {
  ...
  methods: {
    isShowOperate(edit, data) {
      ...
      case 1:  // '编辑'
      case 2:  // '分配权限'
        return this.$menuPermission('sysmana/role/editrole');
      case 3:   // '查看权限'
        return this.$menuPermission('sysmana/role/getroleauth');
      case 4:   // '删除'
        return this.$menuPermission('sysmana/role/delrole');
      default:
        return false;
      }
    },
