// src\components\system\role\gain.vue
<template>
  <div class="wrapper" >
    <div class="system-tab">
      <ul class="tab-box">
        ...
        <template v-if="$route.query.id||$route.query.id==0">
          <li @click="goto('power',{ id: $route.query.id })">功能权限</li>
        </template>
        <template v-else>
          <li>功能权限</li>
        </template>
      ...
      gainRole({
        ...
        success: (params) => {
          ...
          if (data.code == 0) {
            ...
            this.$router.push({path:'power',query:{id:data.data.id}});
          } else {
            this.$message.error(data.msg);
          }
    ...
    editRoleHandler(){
      ...
      editRole({
        ...
        success: (params) => {
          ...
          if (data.code == 0) {
            this.$message.success(data.msg);
            this.$router.push({path:'power',query:{id:this.$route.query.id}});
          } else {
            this.$message.error(data.msg);
          }
        },
