// dev\src\components\system\ClientList.vue
<template>
  <div class="wrapper" >
    <div class="system-tab">
      ...
      <router-link
        ...
        v-if="$menuPermission('basedata/clientdata/addeditclient')"
        :to="{path: 'add', query: {}}"
      >+ 添加客户信息</router-link>
    </div>
    <!-- system-search -->
        ...
        <el-table :data="tableData" style="width: 100%" border>
          ...
          <el-table-column label="操作" align="center" width="100">
            <template slot-scope="scope">
              ...
              >编辑</router-link>
              <router-link
                v-if="$menuPermission('basedata/clientdata/client_info')"
                :to="{path: 'detail', query: {id:scope.row.id}}"
              >查看</router-link>
              <span v-if="!$menuPermission('basedata/clientdata/addeditclient,basedata/clientdata/client_info')">--</span>
            </template>
          </el-table-column>
        </el-table>
      </div>
