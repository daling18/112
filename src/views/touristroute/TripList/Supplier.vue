  ...
  <el-container direction="vertical" class="list">
    ...
    <el-footer>
      <Affix :offset-bottom="0">
        <pagination ref="pagination" @change="pageChange" :apiFun="getSupplier" :params="postData" class="pagination"></pagination>
      </Affix>
    </el-footer>
  </el-container>
</template>
<script>
import { getSearch, getSupplier } from "src/api/touristroute";
...
export default {
  ...
  data() {
    return {
      buttons: ["detail", "channel", "bulk-shelves", "batch-approval", 'approval-detail'],
      getSupplier,
      searchData: null,
      filter: {},
      search: {
