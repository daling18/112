...
<template>
  <el-container direction="vertical" class="list">
    <el-main>
      ...
      <el-row class="section product-section">
        <product-list :data="productData" :buttons="buttons" @refresh="handleSearch" :status-map-text="statusMapText"></product-list>
      </el-row>
    </el-main>
    <el-footer>
      <Affix :offset-bottom="0">
        <pagination ref="pagination" @change="pageChange" :apiFun="getSelfSupport" :params="postData" class="pagination"></pagination>
      </Affix>
    </el-footer>
  </el-container>
</template>
<script>
import { getSearch, getSelfSupport } from "src/api/touristroute";
