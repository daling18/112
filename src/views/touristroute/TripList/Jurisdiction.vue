  ...
  <el-container direction="vertical" class="list">
    ...
    <el-footer>
      <Affix :offset-bottom="0">
        <pagination ref="pagination" @change="pageChange" :apiFun="getBusiness" :params="postData" class="pagination"></pagination>
      </Affix>
    </el-footer>
  </el-container>
</template>
<script>
import { getSearch, getBusiness } from "src/api/touristroute";
