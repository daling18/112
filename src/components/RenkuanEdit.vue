// src/components/sale/recognition/peer-recog.vue
<template>
  <div class="wrapper">
    <!-- system-search -->
...
<script>
import {
  // saleBeforeAddRenkuanList, saleRenkuanAdd,
...
export default {
  ...
  computed: {
    ...
    getRenkuanListFunc(){
      return beforeAddRenkuanList;
      // switch(this.topMenuConst){
      // case 'sale':
      // case 'distribution':
      //   return saleBeforeAddRenkuanList;
      // case 'operator':
      //   return beforeAddRenkuanList;
      // }
    },
