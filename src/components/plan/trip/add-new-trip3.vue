        ...
        <div class="form-content">
          <el-form :model='data' label-width="100px">
            ...
            <el-form-item label="行程特色" class="trip-textarea">
              ...
              <div class="fontlength">{{data.trip_features.length}}/5000</div>
            </el-form-item>
            <el-form-item label="费用包含" required="">
              ...
              <div v-if="feeIncludesType == 'richText'" class="fontlength">{{fee_includes_length}}/5000</div>
            </el-form-item>
            <el-form-item label="费用不包含" required="">
              ...
              <div v-if="costExcludesType == 'richText'" class="fontlength">{{cost_excludes_length}}/5000</div>
            </el-form-item>
            <el-form-item label="预定须知">
              <vue-editor v-model="data.booking_info"></vue-editor>
              <div class="fontlength">{{booking_info_length}}/5000</div>
            </el-form-item>
            <el-form-item label="安全说明">
              <vue-editor v-model="data.safety_info"></vue-editor>
              <div class="fontlength">{{safety_info_length}}/5000</div>
            </el-form-item>
            <el-form-item label="备注">
              <vue-editor v-model="data.remark"></vue-editor>
              <div class="fontlength">{{remark_length}}/5000</div>
            </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doStep3() {
        if(this.data.trip_features.length > 5000) {
          this.$message({
            message: '行程特色不能超过5000字符',
            type: 'error'
          })
          return ''
        };
        if(this.feeIncludesType == 'table'){
          ...
          if(this.fee_includes_length > 5000) {
            this.$message({
              message: '费用包含不能超过5000字符',
              type: 'error'
            })
            return ''
          };
        ...
        if(this.costExcludesType == 'table'){
          ...
          if(this.cost_excludes_length > 5000) {
            this.$message({
              message: '费用不包含不能超过5000字符',
              type: 'error'
            })
            return ''
          };
        ...
        if(this.booking_info_length > 5000) {
          this.$message({
            message: '预定须知不能超过5000字符',
            type: 'error'
          })
          return ''
        };
        if(this.safety_info_length > 5000) {
          this.$message({
            message: '安全说明不能超过5000字符',
            type: 'error'
          })
          return ''
        };
        if(this.remark_length > 5000) {
          this.$message({
            message: '备注不能超过5000字符',
            type: 'error'
          })
          return ''
        };
