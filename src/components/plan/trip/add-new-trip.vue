    ...
    <div class="system-content">
      <div class="mod-form">
        <div class="add-trip-wrapper">
          <el-form :model="data" :rules="rules" ref="ruleForm" label-width="120px">
            ...
            <div class="form-content">
              ...
              <el-form-item class="upload-wrapper" label="行程图片" required>
                ...
                <span class="el-upload__tip">最多上传3张，原图分辨率最少不能低于480*480，支持jpg，jpeg，gif，png格式，2M以内图片</span>
...
<script>
  ...
  import {getProductTheme} from 'src/api/product'
  ...
  export default {
    ...
    methods: {
      ...
      beforeTripPicUpload(file) {
        ...
        if (!isLt2M) {
          this.$message.error('上传行程图片大小不能超过 2MB!');
          this.limit_pic--;
        }
      ...
      submit(type) {
        ...
        this.$refs.ruleForm.validate((valid) => {
          if (valid) {
            ...
            if (type === '1' && this.topMenuConst === 'supplier') {
