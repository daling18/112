    ...
    <div class="el-tabs__header">
      <div class="el-tabs__nav-wrap">
        <div class="el-tabs__nav">
          <div
            v-if="permission.orderDetil"
            class="el-tabs__item"
            @click="$router.push({ name: orderDetailName, query: { orderNo: $route.query.orderNo }})"
          >订单详情</div>
          <div class="el-tabs__item is-active">退款详情</div>
        </div>
      </div>
    </div>
              ...
              <table class="table-order">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {{ refund.passengersename }}
                      <br />
                      {{ refund.passporttypeseidname }}
                    </td>
                    <td>{{ refund.train_refund_fee }}</td>
                    <td>{{ refund.refund_status }}</td>
                    <td>{{ refund.real_refund_amount }}</td>
                    <!-- <td>{{ refund.finance_refund_status }}</td> -->
                    <!-- <td>
      ...
      <div class="fixed-loss">
        ...
        <div class="radio-block">
          <div class="radio-txt">
            ...
            <p>
              现订单的应收金额{{fixedLossInfo.order_amount}}，您同意应退款金额为
              <el-input v-model="fixedLossForm.amount"></el-input>元？
            </p>
          </div>
        </div>
  ...
  computed: {
    orderType() {
      let routeName = this.$route.name,
        type = "";
      switch (routeName) {
        case "TrainSaleOrderRefundDetail":
          type = "SaleOrder";
          break;
        case "DistributionTrainPurchaseOrderRefundDetail":
          type = "PurchaseOrder";
          break;
        case "TrainSingleOrderRefundDetail":
          type = "SingleOrder";
          break;
    ...
    orderDetailName() {
      ...
      switch (type) {
        case "SaleOrder":
          routeName = "TrainSaleOrderDetail";
          break;
        case "PurchaseOrder":
          routeName = "DistributionTrainPurchaseOrderDetail";
          break;
        case "SingleOrder":
          routeName = "TrainSingleOrderDetail";
          break;
        case "financeRefund":
    ...
    permission() {
      ...
      switch (type) {
        case "SaleOrder":
          permission.orderDetil = this.$menuPermission(
        ...
        case "SingleOrder":
          ...
          permission.fixedLoss = this.$menuPermission(
            "singlepro/singleorder/train/loss"
          );
          break;
      }
