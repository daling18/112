          ...
          <template slot-scope="prop">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-if="$menuPermission('api/selfsupport.hotel/detail')">
                  <router-link :to="{ name: 'SelfSupportDxHotelDetail', query: { hotelId: prop.row.id } }">详情</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('api/selfsupport.hotel/store')">
                  <router-link :to="{ name: 'SelfSupportDxHotelEdit', query: { id: prop.row.id } }">编辑</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('api/selfsupport.hotel/roomList')">
                  <router-link :to="{ name: 'SelfSupportDxRoom', query: { hotel_name: prop.row.hotel_name } }">房型</router-link>
                </el-dropdown-item>
                <el-dropdown-item v-if="$menuPermission('api/selfsupport.hotel/storeRoom')">
                  <router-link :to="{ name: 'SelfSupportDxRoomAdd', query: { hotelId: prop.row.id, hotelName: prop.row.hotel_name } }">添加房型</router-link>
                </el-dropdown-item>
                <template v-if="$menuPermission('api/selfsupport.hotel/changeStatus')">
                  <template v-if="prop.row.status == 1">
                    <el-dropdown-item>
