    ...
    <div class="system-search clearfix">
      <div class="clearfix">
        <!-- <div class="search-item">
          ...
          <el-input v-model="searchData.supplier_org_name"></el-input>
        </div> -->
        <div class="search-item">
            ...
            <template slot-scope="scope">
              <el-dropdown trigger="click">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item>
                    <router-link :to="{path: '/self-support/localProduct/detail', query: {id: scope.row.id}}">详情</router-link>
                  </el-dropdown-item>
                  <el-dropdown-item>
                    <router-link 
                      v-if="scope.row.audit_status !== 2 && scope.row.audit_status !== 3"
                      :to="{path: '/self-support/localProduct/add', query: {id: scope.row.id}}">
                      编辑
                    </router-link>
                  </el-dropdown-item>
                  <el-dropdown-item>
