<template>
  <div class="wrapper">
    <div class="system-tab">
      ...
      <div class="btn">
        <el-button type="primary" @click="$router.push({path:'/self-support/hotel-brand/edit'})">+ 新增品牌</el-button>
      </div>
    </div>
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="text"
                @click="$router.push({path:'/self-support/hotel-brand/detail', 
                                     query:{id:scope.row.id}})">详情</el-button>
              <el-button type="text" 
                @click="$router.push({path:'/self-support/hotel-brand/edit', 
                                     query:{id:scope.row.id}})">编辑</el-button>
              <el-button type="text" @click="brandDeleteHandler(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
