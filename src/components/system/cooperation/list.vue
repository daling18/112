<template>
  <div class="wrapper supplier-wrap">
    <div class="system-tab">
      ...
      <div class="btn">
        <router-link v-if="$menuPermission('api_supplier/supplier/have_not_cooperative_customers')" :to="{path: '/system/cooperation/check-list'}">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <span class="oper-span"
                ...
                :key="i">
                <router-link v-if="o == 1"
                  :to="{path: '/system/cooperation/view-detail', query:{id:scope.row.id}}">
                  {{allData.edit_arr[o]}}
                </router-link>
                <router-link v-else-if="o == 2"
                  :to="{path: '/system/cooperation/edit-detail', query:{id:scope.row.id}}">
                  {{allData.edit_arr[o]}}
                </router-link>
                <router-link v-else-if="o == 5"
                  :to="{path: '/system/cooperation/resign-detail', query:{id:scope.row.id}}">
                  {{allData.edit_arr[o]}}
                </router-link>
              </span>
            </template>
