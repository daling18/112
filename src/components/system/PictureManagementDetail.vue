    ...
    <div class="system-content">
      <div class="content-list">
        <div class="top-menu clearfix">
          ...
          <span @click="delPhotoalbumSub()" class="color-purple cur">批量删除</span>
          <el-upload
            class="uploadbtn"
            action="api/photoalbum/upload_pic"
        ...
        <div v-if="pictureList.length > 0" class="album-wrap clearfix">
          <el-checkbox-group v-model="checkList">
            <div v-for="(item, index) in pictureList" class="album-item" :key="index">
              <span @click.prevent="delPhotoalbumSub(item.id)" class="album-close">X</span>
