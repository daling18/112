<template>
  <div class="wrapper">
    <div class="system-tab">
      <ul class="tab-box">
        <li class="on">组织机构</li>
        <router-link v-if="$menuPermission('api/orgination/self_detail')" tag="li" to="/organization/self">所属组织信息</router-link>
      </ul>
      <el-button
        class="right-btn"
        v-if="$menuPermission('api/orgination/add_org')"
        type="primary"
        size="long"
      ...
      <div class="form-content">
        <el-form :model="form" label-width="130px">
          ...
          <template v-if="orgTypeMap[form.org_type] && orgTypeMap[form.org_type] != '部门'">
            ...
            <el-form-item label="统一社会信用代码" prop="taxpayer_num" v-else>
...
import ExpandTable from './ExpandTable.comp'
import BaiduMap from './BaiduMap.comp'
