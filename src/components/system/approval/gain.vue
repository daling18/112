          ...
          <div class="form-content">
            ...
            <el-form-item label="是否需要审批"
              ...
              <el-col :span="24">
                ...
                <el-radio v-model="ruleForm.need_approval" label='2'>
                  不需要审批
                </el-radio>
              </el-col>
            </el-form-item>
            <el-form-item label="审批人"
              ...
              <div v-for="(o,i) in allData.end_staffs"
                ...
                <el-col :span="21">
                  <div class="spbox">
                    <div class="btn-box">
                      <el-button type="primary" class="ml10" @click="handleSelectMember(2,'open',i)">添加</el-button>
                      <el-button type="button"
          ...
          edit_approval_config({
            ...
            success: res => {
              ...
              if (code == 0) {
                ...
                this.$router.push({ path: "/system/approval/config-list" });
              } else {
                this.$message.error(msg);
