		...
		<div class="content">
			<el-table :data="tableData"
				...
				<el-table-column label="操作"
					...
					:resizable="false">
					<template slot-scope="scope">
						<router-link :to="{path:'/fin/b/report', query:{id:scope.row.id}}">
							查看报表
						</router-link>
					</template>
				</el-table-column>
				<el-table-column label="报表快捷入口"
					...
					<template slot-scope="scope">
						...
						<router-link :to="{path:'/fin/b/report-contract', query:{id:scope.row.id}}">
							合同登记台账
						</router-link>
						<router-link :to="{path:'/fin/b/report-invoice', query:{id:scope.row.id}}">
							发票开具表
						</router-link>
						<router-link :to="{path:'/fin/b/report-cost', query:{id:scope.row.id}}">
							成本回票表
						</router-link>
						<router-link :to="{path:'/fin/b/report-journal', query:{id:scope.row.id}}">
							分公司银行日记账
						</router-link>
						<router-link :to="{path:'/fin/b/report-month', query:{id:scope.row.id}}">
							周数据明细
						</router-link>
					</template>
				</el-table-column>
