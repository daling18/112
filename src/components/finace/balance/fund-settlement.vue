<template>
	<div  class="wrapper">
		<div class="system-tab">
			<ul class="tab-box">
				<li class="on">同行结算</li>
				<template  v-if="$menuPermission('api/zhike/customer_settlement_list')">
					<li  @click="goto('/dire-settlement',{})">直客结算</li>
				</template>
				<!-- <li v-if="orgtype != 1 && orgtype != 0" @click="goto('/channel-settlement',{})">
					渠道结算
				</li> -->
			</ul>
		</div>
      ...
      <div class="form-content configureForm-content">
        <el-form :model="configureForm" :rules="rules" label-width="110px" ref="configureForm">
          <el-form-item label="授信额度" prop="credit_line" auto-complete="off">
             <input-number  v-model="configureForm.credit_line" class="max-w250"/>
          </el-form-item>
