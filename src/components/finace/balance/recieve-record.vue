    ...
    <div class="content-list">
      ...
      >
        ...
        <!-- <el-table-column label="操作" align="center" width="100" fixed="right">
            <template slot-scope="scope">
              <el-button v-if="$menuPermission('api/finance/edit_receipt')" type="text" @click="goto('/fund-settlement/recieve-record/recieve-edit',{action:2,id:scope.row.id,relate_id:$route.query.id})">编辑收款</el-button>
            </template> 
          <template slot-scope="scope">
            <router-link 
            ...
            >审核</router-link><template v-else-if="(scope.row.payment_status != 3) && $menuPermission('api/tuan/financial_settle_get_gathering_info,api/finance/payment_cancel')">
              <router-link 
