          ...
          <table class="pdf-table">
            <tbody>
              ...
              <tr>
                ...
                <td width="20%">成本编号：{{pdfCon.item_no}}</td>
                      ...
                      <tr>
                        <td width="50%">
                          <div class="zhang-wrap">
                            ...
                            <p>我社确认／盖章</p>
                            <img :src="pdfCon.seal_yk" class="zhang">
                          </div>
                        </td>
                        <td width="50%">
                          贵社确认／盖章
...
<script>
  import {orderConfirmTemplate} from 'src/api/api'
  export default {
    data() {
      return {
    ...
    computed: {
      upload() {
        return "/bom/api/tuan/save_order_confirm_pdf?id=" + this.id + "&tuan_id=" + this.tuan_id
      }
    },
    methods: {
