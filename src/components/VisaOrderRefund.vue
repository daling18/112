// src\components\distribution\VisaOrderRefund.vue
<template>
  <div class="wrapper">
        ...
        <table class="el-table el-table-center">
          ...
          <tbody>
            <tr>
              ...
              <td><div class="cell">
                <a v-if="item.is_op_loss == 1 && lossPerm" href="javascript:;" @click="handleLossAssess(item)">
                  定损
                </a>
                <span v-else> -- </span>
              </div></td>
...
export default {
  ...
  computed: {
    ...
    lossPerm() {
      ...
      case 'singlepro': 
        if (!this.isSingleOrder) {
          return this.$menuPermission('singlepro/selforder/visaorder/loss')
        }
        break;
      default:
        return false;
