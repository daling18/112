// src\components\distribution\OrderPriceItem.comp.vue
<template>
  <div class="detail-form bg-white">
    ...
    <div class="field-item">
      ...
      <div class="field-content flex aic">
        <dir class="flex-1">
          <el-select slot="prepend" v-model="item.operator" style="width: 70px; color: #000" @change="handleCalcPriceDetailPrice(item, $event)">
