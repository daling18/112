  ...
  data() {
    return {
      TAB_LIST: {
        hotel: {
          name: '酒店订单',
          path: '/plan/selfsupport-hotel-order',
          permission: this.$menuPermission('api/hotel/orderList/3')
        },
        ticket: {
          name: '门票订单',
          path: '/plan/selfsupport-ticket-order',
        ...
        qz: {
          name: '签证订单',
          path: '/plan/visa-selfsupport-order',
          permission: this.$menuPermission('api/selfsupport.visaorder/op_self_order_list')
        },
        localProduct: {
          name: '农特优订单',
          path: '/plan/selfsupport-local-product-order',
          permission: this.$menuPermission('api/selfsupport.localproductorder/self_lists')
        }
      }
    }
  },
