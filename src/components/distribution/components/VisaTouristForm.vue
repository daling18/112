<template>
  <el-form class="tourist-form" label-width="170px">
    ...
    <el-form-item label="中文姓名" class="w530" required>
      <el-input v-model="tourist.name" placeholder="请输入中文姓名"/>
    </el-form-item>
    <el-form-item label="英文姓名" class="w530">
      <el-input class="w175" v-model="tourist.first_name" placeholder="姓（拼音或英文）"/><el-input class="ml10 w175" v-model="tourist.last_name" placeholder="名（拼音或英文）"/>
    </el-form-item>
