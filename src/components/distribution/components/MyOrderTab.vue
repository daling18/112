  ...
  data() {
    return {
      TAB_LIST: {
        ...
        hotel: {
          name: '酒店订单',
          path: '/distribution/hotel-order',
          permission: this.$menuPermission('api/hotel/orderList/2')
        },
        ticket: {
          name: '门票订单',
        ...
        train: {
          name: '火车票订单',
          path: '/distribution/train-order',
          permission: this.$menuPermission('api/train/my_order_list')
        },
        // bx: {
        //   name: '保险订单',
