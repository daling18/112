    ...
    <div class="el-tabs__header">
        <div class="el-tabs__nav-wrap">
            <div class="el-tabs__nav">
                <div class="el-tabs__item" @click="$router.push({ name: orderDetailName, query: { orderId: $route.query.orderId }})">
                    订单详情
                </div>
              ...
              <table class="table-order">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a v-if="$menuPermission('api/hotel/fixedLoss') && refund.refund_status == 3 
...
<script>
import { getDistributionHolelMyOrderRefundDetailAsyncRequest, getDistributionHolelSingleOrderRefundDetailAsyncRequest, getDistributionHolelSelfSupportOrderRefundDetailAsyncRequest, setDistributionHolelOrderFixedLossAsyncRequest } from 'src/api/hotel';
export default {
  data () {
    return {
      refundDetail: null,
  ...
  computed:{
    orderType(){
      let routeName = this.$route.name,
          type = '';
      switch(routeName){
        case 'DistributionHotelMyOrderRefundDetail':
          type = 'MyOrder';
          break;
        case 'DistributionHotelPurchaseOrderRefundDetail':
          type = 'PurchaseOrder';
          break;
        case 'DistributionHotelSingleOrderRefundDetail':
          type = 'SingleOrder';
          break;
        case 'DistributionHotelSelfSupportOrderRefundDetail':
