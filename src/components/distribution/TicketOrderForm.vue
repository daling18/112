            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="姓名" prop="contact.name">
                  <el-input v-model="orderForm.contact.name" :class="'hotel-checkout-form-input'" placeholder="请输入取票人姓名"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
						...
						<el-row>
							...
							<el-col :span="8">
								<el-form-item  label="证件号码" prop="contact.identity_no">
									<el-input v-model="orderForm.contact.identity_no" :class="'hotel-checkout-form-input'" placeholder="请输入取票人证件号码"></el-input>
								</el-form-item>
							</el-col>
						</el-row>
						<el-row>
					...
					this.$confirm('预订成功', '在线支付提示', {
						...
						beforeClose: (action, instance, done) => {
							if(action == 'confirm'){
								...
								let path = '/distribution/ticket-order/detail';
