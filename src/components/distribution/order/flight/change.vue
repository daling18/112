      ...
      <div class="el-tabs__nav-wrap">
        <div class="el-tabs__nav">
          <div class="el-tabs__item">
            <router-link :to="{ path: '/order/flight/order_detail', query: { order_id: $route.query.order_id }}">订单详情</router-link>
          </div>
          <div class="el-tabs__item is-active">
            <router-link :to="{ path: '/order/flight/change_order', query: { order_id: $route.query.order_id }}">变更单详情</router-link>
          </div>
          <div class="el-tabs__item">
            <router-link :to="{ path: '/order/flight/refund_order', query: { order_id: $route.query.order_id }}">退款单</router-link>
          </div>
        </div>
    </div>
    </div>
