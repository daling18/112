                        ...
                        <tr v-for="(td,tid) in scope.row.tourist_list" :key="tid">
                          ...
                          <td>{{td.name}}
                            <span v-if="scope.row.order_type == 1">
                              <router-link :to="{ path: '/order/flight/change_order', query: { order_id: orderData.order_id }}" 
                                    v-if="td.change_status"
                                    class="mark">变</router-link>
                              <router-link :to="{ path: '/order/flight/refund_order', query: { order_id: orderData.order_id }}" 
                                    v-if="td.refund_status"
                                    class="mark">退</router-link>
                            </span>
                            <span v-if="scope.row.order_type == 2">
                              <router-link :to="{ path: '/order/flight/internation_change_order', query: { order_id: orderData.order_id }}" 
                                    v-if="td.change_status"
                                    class="mark">变</router-link>
                              <router-link :to="{ path: '/order/flight/internation_refund_order', query: { order_id: orderData.order_id }}" 
                                    v-if="td.refund_status"
                                    class="mark">退</router-link>
                            </span>
                          </td>
                      ...
                      <a href="javascript:;" class="look"  slot="reference" style="color:#555;">
                        <p>{{scope.row.tourist_list[0].name}}
                          <router-link :to="{ path: scope.row.order_type == 1?'/order/flight/change_order':'/order/flight/internation_change_order', 
                                        ...
                                        class="mark">变</router-link>
                          <router-link :to="{ path:  scope.row.order_type == 1?'/order/flight/refund_order':'/order/flight/internation_refund_order', 
                                        query: { order_id: scope.row.order_id }}" 
