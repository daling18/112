      ...
      <ul class="tab-box">
        <template>
          ...
          <router-link :to="{ name: orderTypeRouterName.orderRefundDetailName, query: { order_id: $route.query.order_id}}" 
            v-if="detailInfo.order_info.status_code == 12"
            tag="li">
            退款详情
          </router-link>
        </template>
      ...
      <div class="bd">
        ...
        <table class="table-custom">
          ...
          <tr>
            ...
            <td>{{detailInfo.order_info.unpaid_amount}}</td>
            ...
            <td>
              <el-dropdown trigger="click" v-if="detailInfo.order_info.allow_operation && detailInfo.order_info.status_code != 3">
                ...
                <el-dropdown-menu slot="dropdown">
                  <template v-if="orderType == 'MyOrder' || orderType == 'SingeOrder'">
    ...
    <div class="panel" v-if="detailInfo.product_info" >
      ...
      <div class="bd">
        ...
        <table class="table-custom">
          ...
          <tr>
            <td>{{detailInfo.product_info.scenic_title + '/' +detailInfo.product_info.product_name}}</td>
            ...
            <td>
              <el-popover
                  ...
                  <div class="popover-table">
                    <table>
                      ...
                      <tr>
                        <th>退票手续费</th>
                        <td>
                         {{ detailInfo.product_info.refund_rule.refund_fee }}
                        </td>
                      </tr>
                      <tr>
                        <th>阶梯退票</th>
                  ...
                  <span class="popover-text" slot="reference">退票规则</span>
                </el-popover>
            </td>
          </tr>
        </table>
    ...
    <div class="panel" v-if="detailInfo.product_info" >
      ...
      <div class="bd">
        <div class="info-list">
          ...
          <span><i>结算总金额：</i>{{detailInfo.order_info.total_price}}</span>
          <span><i>本位币：</i>{{detailInfo.order_info.total_price}}</span>
        </div>
        <table class="table-custom">
          <tr>
            <th>序号</th>
    ...
    getOrderDetailFun(){
      ...
      switch(type){
        case 'MyOrder':
          ...
          break;
        case 'PurchaseOrder':
          fun = getTicketPurchaseOrderDetail;
          break;
        case 'SingleOrder':
